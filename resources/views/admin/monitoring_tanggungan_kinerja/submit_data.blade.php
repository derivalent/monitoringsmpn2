    ...
    <main>
        <div class="container-fluid px-4">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('Penugasan.submitUpdate_data', $penugasan->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <a href="{{ route('Penugasan.index_data') }}" class="btn btn-secondary">Cancel</a>
                    </form>
                </div>
            </div>
        </div>
