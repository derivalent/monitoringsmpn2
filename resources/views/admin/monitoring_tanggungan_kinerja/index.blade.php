                        ...
                        <div class="row align-items-center">
                            <div class="col-12 d-flex align-items-center justify-content-between flex-wrap">
                                ...
                                <div class="d-flex align-items-center flex-wrap">
                                    <form method="GET" action="{{ route('Penugasan.index') }}" class="d-flex align-items-center">
                            ...
                            <tbody>
                                @foreach ($penugasan as $index => $item)
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{ route('Penugasan.changeStatus', $item->id) }}" method="POST" style="display: flex; justify-content: center; gap: 8px;">
                                                @csrf
                                                <button type="submit" name="status" value="Diperbaiki" class="btn btn-warning btn-sm">
                                        ...
                                        <td style="white-space: nowrap;">
                                            <div style="display: flex; justify-content: space-around; align-items: center; gap: 8px;">
                                                ...
                                                <form action="{{ route('Penugasan.submit', $item->id) }}" method="POST">
                                                    @csrf
                                                    <button type="submit" class="btn btn-sm" style="background: none; border: none; color: rgb(6, 91, 229); padding: 0;">
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="detail-item">
                                                        <span class="detail-label">Kegiatan</span>
                                                        <span class="detail-value">: &nbsp;{{ $item->kategoriKegiatan->kategori_kegiatan ?? 'N/A' }}</span>
                                                    </div>
                                                    <div class="detail-item">
                                                    ...
                                                    <div class="detail-item">
                                                        ...
                                                        <span class="detail-value">: &nbsp;{{ $item->pengumpulan ?? 'Belum Dikirim' }}</span>
                                                    </div>
                                                </div>
                                ...
                                <tbody>
                                    @foreach ($penugasan as $index => $item)
                                        <tr>
                                            ...
                                            <td>
                                                {{-- <a href="{{ Storage::url($item->file) }}" target="_blank"> --}}
                                                <a href="{{ asset('storage/files/' . basename($item->file)) }}" target="_blank">
                                            ...
                                            <a class="btn btn-sm" href="{{ route('Penugasan.edit', $item->id) }}" style="background: none; border: none; color: orange; padding: 0; margin-right: 8px;">
                                                <i class="fas fa-edit" style="font-size: 15px;"></i>
                                            </a>
                                            <form action="{{ route('Penugasan.submit', $item->id) }}" method="POST" style="display:inline;">
                                                @csrf
                                                    <button type="submit" class="btn btn-sm" style="background: none; border: none; color: rgb(6, 91, 229); padding: 0; margin-right: 8px;">
